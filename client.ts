  ...
  <div className="relative mx-auto max-w-md lg:max-w-none">
    ...
    <div className="relative rounded-[2rem] border border-white/15 bg-white/10 p-5 backdrop-blur shadow-elegant">
      <div className="flex items-center gap-4">
        <img src={logo} alt="NearbyPro" className="h-28 w-28 md:h-36 md:w-36 rounded-[2rem] bg-white p-3 object-contain shadow-glow" />
        <div className="text-left">
          <div className="text-2xl md:text-3xl font-bold">NearbyPro South Africa</div>
