...
import { Search, MapPin, Wrench, Zap, Car, Scissors, HardHat, Sparkles, PaintBucket, Flame, Star, Shield, Clock, Laptop, Hammer, Leaf, Truck, PartyPopper, GraduationCap, Briefcase, HeartPulse, CarFront } from 'lucide-react';

const ICONS: Record<string, any> = { Wrench, Zap, Car, Scissors, HardHat, Sparkles, PaintBucket, Flame, Laptop, Hammer, Shield, Leaf, Truck, PartyPopper, GraduationCap, Briefcase, HeartPulse, CarFront };
          ...
          <div className="container relative py-12 md:py-20 grid lg:grid-cols-[1fr_420px] gap-10 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-balance max-w-3xl mx-auto lg:mx-0">
                <span className="typing-gradient">Find trusted local pros</span> <span className="text-accent">near you.</span>
              </h1>
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                <Button asChild size="lg" variant="secondary"><Link to="/become-pro">Become a Pro</Link></Button>
              </div>
            </div>
            <HeroVisual />
          </div>
